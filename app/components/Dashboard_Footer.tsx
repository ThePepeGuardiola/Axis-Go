...
export const BottomNav = () => {
  const { logout, safeNavigate } = useAuth();
  ...
  return (
    <View style={styles.bottomNav}>
      ...
      <NavButton1 onPress={() => handleNavigation('/Auth/home')} iconPath="M2.92542 14.8235L13.3723 4.37659C13.8849 3.86403..." width={29} height={29} />
      <NavButton2 onPress={() => handleNavigation('/Auth/search')} iconPath="M13.6945 4.90534C13.9187 4.36637..." width={29} height={29} />
      ...
      <NavButton3 onPress={() => handleNavigation('/Auth/notifications')} iconPath="M25.4772 14.8235C25.4772 13.3738..." width={29} height={29} />
      ...
      {menuVisible && (
        <Animated.View style={[styles.menu, { transform: [{ translateY: slideAnim }] }]}> 
          <TouchableOpacity onPress={() => { closeMenu(); handleNavigation('/Auth/PerfilUsuario'); }} style={styles.menuItem}>
